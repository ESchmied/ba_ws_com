...
const std::string waypoint_file = "/home/emelies/ros_mpc_env/ba_ws_com/maps/Spielberg_map_filled_centerline.csv"; //raceline funktioniert nicht, weil dann die constraint berechnung nicht mehr funktioniert
